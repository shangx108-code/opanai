...
- [x] Canonical project slug and first-start timestamp locked
- [x] Long-term root bootstrap files added (`README`, config, requirements, bootstrap, hourly driver)
- [x] `A-B` convention scan package archived
- [x] `k`-path mapping scan package archived
- [x] Shared mixed-star scan package archived
...
- [ ] Final BTK / robustness manuscript-grade benchmark archived
- [ ] Final manuscript source / replacement text archived
- [ ] Submission-ready main manuscript PDF archived
- [ ] Submission-ready supplementary PDF archived
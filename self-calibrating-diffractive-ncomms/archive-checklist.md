# 归档清单：self-calibrating-diffractive-ncomms

## 已归档
- 上传提案索引：`/workspace/user_files/01-markdown-1-md-3`
- round1 理论说明：`/workspace/self-calibrating-diffractive-ncomms/round1_theory_note.md`
- round1 数值脚本：`/workspace/self-calibrating-diffractive-ncomms/round1_pilot_selfcalibration.py`
- round1 指标表：`/workspace/self-calibrating-diffractive-ncomms/outputs/round1_metrics.csv`

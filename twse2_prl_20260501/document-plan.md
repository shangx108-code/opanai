...
- [x] Create a PRL-style manuscript draft for the current `twse2_prl_20260501` results.
- [x] Use the `academic-deai` workflow to keep claims natural, disciplined, and evidence-bounded.
- [x] Keep the manuscript aligned with the current minimal engine outputs only: two-scale DOS calibration and interface-proxy pairing screening.

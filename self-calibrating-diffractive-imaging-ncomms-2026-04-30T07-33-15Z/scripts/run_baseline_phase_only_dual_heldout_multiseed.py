#!/usr/bin/env python3
"""Run dual-ledger held-out evaluation for a shared 3-layer phase-only frontend."""
...
def run_seed(
    ...
    same_family_samples = build_split_samples(train_objects, "heldout_aberration", heldout_cases, config)
...
def main() -> int:
    ...
    out_dir = project_root / "results" / "baselines" / "baseline-004-phaseonly-dual-heldout-multiseed"

# Figure 5 Broad-Window Package

## Scope
- Decision locked on 2026-05-01: Figure 5 will use the upgraded broad-window version rather than the narrower zero-bias-only framing.
- Selected readout: `symmetric_nonlocal_score`
- Source data: `data/fig5-observable-upgrade-2026-05-01/`

## Figure 5 caption replacement
...
- Do say that the broad-window readout is a derived, balanced nonlocal score built from the same heatmaps.
- Do not say that this step introduces a new transport simulation or a stronger microscopic solver.
- Do not imply that the broad-window readout alone proves topology; it is still one layer in the joint transport-plus-topology argument.

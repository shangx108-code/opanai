...
- [x] Expanded transport benchmark script
- [x] Positive-control transport and bias-trace CSV outputs
- [x] Smooth-dot transport and bias-trace CSV outputs
...
- [x] `/workspace/output/transport-benchmark/positive_vz_scan.csv`
- [x] `/workspace/output/transport-benchmark/smooth_dot_scan.csv`
- [x] `/workspace/output/transport-benchmark/impurity_scan.csv`
- [x] `/workspace/output/transport-benchmark/disorder_scan.csv`
- [x] `/workspace/output/transport-benchmark/eta_scan.csv`
- [x] `/workspace/output/transport-benchmark/positive_bias_trace.csv`
